...
import oauth2_provider.handlers
from oauth2_provider.handlers import collect


DEFAULT_ID_TOKEN_HANDLERS = (
    oauth2_provider.handlers.BasicHandler,
    oauth2_provider.handlers.ProfileHandler
)
